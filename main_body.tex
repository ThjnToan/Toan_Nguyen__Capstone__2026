...
Value-added production combines labor and effective capital services:
	...
	Table~\ref{tab:reliability_numerical} in Appendix~\ref{app:reliability} illustrates this nonlinearity: a 10\% flexibility deficit reduces reliability by 1.26~pp, but a 50\% deficit causes a 14.32~pp collapse.\footnote{The accelerating penalty motivates the Reliability Valley analysis in Section~\ref{sec:results}.}
