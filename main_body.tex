...
\paragraph{Euler equation for capital.} With proportional taxation, the after-tax return to capital in period $t+1$ is $(1-\tau)\alpha Y_{t+1}/K_{p,t}$, where $\tau$ is the fixed tax rate. The intertemporal optimality condition becomes:\footnote{The mathematical derivation is in Appendix~\ref{app:deriv_euler}.}
	\begin{equation}
