...
\begin{frame}{Appendix: External Sector Equations}
  ...
  \[
    r^*_t = \bar{r} + \phi_b\!\left(e^{\bar{B}^*-B^*_t}-1\right), \quad \phi_b=0.039
  \]
		...
		\begin{column}{0.47\textwidth}
			\begin{block}{Grid Investment (Government, Sluggish)}
				\begin{itemize}\small
					...
					\item Financed by fixed proportional taxes ($\tau_{ss} \approx 1.43\%$); Ricardian equivalence fails
...
\begin{frame}{Calibrated Parameters (II): Innovation, Shocks \& External Sector}
	\begin{center}
		...
		\begin{tabular}{@{}llcl@{}}
			...
			& Debt premium $\phi_b$             & 0.039  & Schmitt-Grohé \& Uribe (2003)\\
